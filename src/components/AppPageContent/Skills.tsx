      ...
      <>
        <ul>
          ...
          <li>
            ...
            А также опыт использования библиотек UI-компонентов: AntDesign, PrimeReact;
          </li>
          <li>
        ...
        <div>
          Если какой-то технологии или инструмента в данном разделе нет, то уверяю вас - 
          оно будет освоено в кратчайшее время
        </div>
      </>
    </ParagraphBlock>
  );
